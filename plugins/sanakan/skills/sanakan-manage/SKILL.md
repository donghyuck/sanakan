---
name: sanakan-manage
description: Configure and operate Sanakan issue-driven coding automation. Use when the user asks to start, inspect, stop or retry Sanakan development and MR publication for a GitLab project. Do not activate for unrelated coding requests.
---
...
Find the user's existing project configuration and run-storage path. Never invent a GitLab project,
